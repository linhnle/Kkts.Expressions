...
namespace Kkts.Expressions.UnitTest
{
    public class DF
    {
        ...
        public static readonly int Interger1 = 2;
        public static readonly int Interger2 = 4;
        public static readonly int Interger3 = 8;
        public static readonly int IntergerN = 16;
